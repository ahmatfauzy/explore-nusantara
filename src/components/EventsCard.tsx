  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8">
        <div>
          <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">UPCOMING EVENT</h2>
          <h1 className="text-3xl font-bold text-gray-800">The Special Occasion of the Year!</h1>
        </div>
        <a href="/events" className="text-blue-600 font-medium hover:text-blue-800 mt-4 md:mt-0 flex items-center">
          Explore More Events →
        </a>
      </div>
