...
const HeroSection = () => {
    ...
    return (
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div 
          className={`absolute max-w-md transition-all duration-700 ease-out ${locations[currentIndex].position} ${
            isChanging 
              ? direction === 'right' 
        ...
        >
          ...
          >
            ...
            <div className={`overflow-hidden transition-all duration-500 ease-out ${
              ...
              <p className="text-white text-sm mb-3">{locations[currentIndex].description}</p>
              <a 
                href="#" 
        ...
        >
          ...
          <div className="flex space-x-8 items-center overflow-hidden" ref={sliderRef}>
            {getVisibleLocations().map((location) => {
              ...
              return (
                <div 
                  ...
                  onClick={() => goToSlide(locations.findIndex(l => l.id === location.id))}
                  onMouseEnter={() => setBottomHoverIndex(location.id)}
                  onMouseLeave={() => setBottomHoverIndex(null)}
                >
                  ...
                  <div className="relative h-0.5 mt-1 w-full overflow-hidden">
                    <div className={`bg-white absolute left-0 right-0 h-full transition-all duration-300 ${
                      isActive ? 'w-full' : 'w-0'
                    }`} />
                  </div>
                    ...
                    {bottomHoverIndex === location.id && (
                      <a 
                        ...
                        style={{
                          ...
                          transform: bottomHoverIndex === location.id ? 'translateY(0)' : 'translateY(8px)'
                        }}
                      >
                        Learn more
                      </a>
